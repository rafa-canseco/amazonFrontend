...
import { convertToWei, createOrderOnChain } from "../utils/contractInteraction";
import { useExchangeRate } from "../hooks/useExchangeRate";
import {
  getUserBorrowingCapacity,
  borrowFromAave,
} from "../utils/aaveInteractions";
  ...
  const handleConfirmAavePayment = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `Successfully borrowed ${totalUSD} USDC from Aave. Transaction hash: ${borrowTx}`,
      });
      ...
      toast({
        ...
        description:
          error instanceof Error
            ? error.message
            : "There was an error processing your Aave payment. Please try again.",
        variant: "destructive",
      });
    } finally {
